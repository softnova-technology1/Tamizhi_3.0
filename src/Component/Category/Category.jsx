...
const cardsData = [
  {
    ...
    image: "https://tamizhiv2.s3.eu-north-1.amazonaws.com/tamizhi2-0/img1.webp",
  ...
  },
  {
    ...
    image: "https://tamizhiv2.s3.eu-north-1.amazonaws.com/tamizhi2-0/img4.webp",
    link: '/war',
    taread: 'VIEW MORE',
    enread: 'மேலும் படிக்க',
  },
  {
    ...
    image: "https://tamizhiv2.s3.eu-north-1.amazonaws.com/tamizhi2-0/Image20260416124818.jpg",
    link: '/culture',
    taread: 'VIEW MORE',
    enread: 'மேலும் படிக்க',
  },
  {
    ...
    image: "https://tamizhiv2.s3.eu-north-1.amazonaws.com/tamizhi2-0/img6.webp",
    link: '/temple',
    taread: 'VIEW MORE',
    enread: 'மேலும் படிக்க',
  },
  {
    ...
    image: "https://tamizhiv2.s3.eu-north-1.amazonaws.com/tamizhi2-0/img7.webp",
    link: '/architecture',
    taread: 'VIEW MORE',
    enread: 'மேலும் படிக்க',
  },
  {
    ...
    image: "https://tamizhiv2.s3.eu-north-1.amazonaws.com/tamizhi2-0/img9.webp",
  ...
  },
  {
    ...
    image: "https://tamizhiv2.s3.eu-north-1.amazonaws.com/tamizhi2-0/img5.webp",
    link: '/poet',
    taread: 'VIEW MORE',
    enread: 'மேலும் படிக்க',
  },
  {
    ...
    image: "https://tamizhiv2.s3.eu-north-1.amazonaws.com/tamizhi2-0/img8.webp",
    link: '/category-books',
    taread: 'VIEW MORE',
    enread: 'மேலும் படிக்க',
  },
  {
    ...
    image: "https://tamizhiv2.s3.eu-north-1.amazonaws.com/tamizhi2-0/img12.webp",
    link: '/lord',
    taread: 'VIEW MORE',
    enread: 'மேலும் படிக்க',
  },
  ...
  },
  {
    ...
    image: "https://tamizhiv2.s3.eu-north-1.amazonaws.com/tamizhi2-0/img10.webp",
    link: '/mythology',
    taread: 'VIEW MORE',
    enread: 'மேலும் படிக்க',
  },
...
export default function Category() {
  ...
  return (
    <>
      <div className={styles.wrapper} style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.45), rgba(0, 0, 0, 0.39)), url("https://tamizhiv2.s3.eu-north-1.amazonaws.com/tamizhi2-0/image.webp")`, backgroundSize: 'cover', backgroundAttachment: 'fixed' }}>
        ...
        <div className={styles.titleSection}>
          ...
          <img src={"https://tamizhiv2.s3.eu-north-1.amazonaws.com/tamizhi2-0/cats.png"} alt="category" className={styles.categoryTitleImg} />
        </div>
              ...
              <div className={styles.gridContainer}>
                {cardsData.map((card) => (
                  <div
                    ...
                    style={{
                      backgroundImage: `url("https://tamizhiv2.s3.eu-north-1.amazonaws.com/tamizhi2-0/parchment_card.webp")`,
