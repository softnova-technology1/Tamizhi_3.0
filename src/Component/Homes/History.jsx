...
const data = [
  {
    ...
    description: {
      ...
      ta: 'தென்னிந்தியாவின் பாரம்பரியத்தை வடிவமைத்த தமிழ் நாகரிகத்தின் வளமிகு மற்றும் பண்டைய வரலாற்றை ஆராயுங்கள்.சங்க இலக்கியம் முதல் கடல்சார் வணிகம் வரை, காலத்தின் சோதனைகளைத் தாண்டி நிலைத்துள்ள வரலாற்றுப் பதிவுகளை வெளிக்கொணுங்கள்.தமிழி, உங்களை அறிவும் வீரமும் நிறைந்த காலத்தால் அழியாத பாரம்பரியத்திற்கு நெருக்கமாக கொண்டு செல்லும்..',
    },
    image: "https://tamizhiv2.s3.eu-north-1.amazonaws.com/tamizhi2-0/historyimg.webp",
  ...
  },
  {
    ...
    description: {
      ...
      ta: 'அதிகாரம், ஞானம் மற்றும் நீதிக்கு புதிய வரையறைகளை உருவாக்கிய புகழ்மிகு தமிழ் அரசர்களை சந்திக்கவும்.வலிமைமிக்க சோழர்கள் முதல் துணிச்சலான பாண்டியர்கள் வரை, அவர்களின் ஆட்சி பல நூற்றாண்டுகளாக இந்திய வரலாற்றில் எதிரொலிக்கிறது.தொலைநோக்குடன், வலிமையுடனும் பேரரசுகளை நிறுவிய மன்னர்களின் வாழ்க்கை வரலாறையும், மரபுகளையும் ஆராயுங்கள்.',
    },
    image: "https://tamizhiv2.s3.eu-north-1.amazonaws.com/tamizhi2-0/kings.webp",
  ...
  },
  {
    ...
    description: {
      ...
      ta: 'தமிழ் கலாச்சாரத்தை வரையறுக்கும் உயிர்விழுங்கும் மரபுகள், கலை மற்றும் பண்டிகைகளில் முழுமையாக மூழ்கிக்கொள்ளுங்கள்.பரதநாட்டியம் முதல் பொங்கல் வரை, ஒவ்வொரு அம்சமும் பெருமையும் அடையாளமும் நிறைந்த கதையைச் சொல்கிறது.தமிழ் வாழ்க்கை முறையின் தாளத்தையும் செழுமையையும் தமிழி மூலமாகக் கொண்டாடுங்கள்....',
    },
    image: "https://tamizhiv2.s3.eu-north-1.amazonaws.com/tamizhi2-0/cultureimg.webp",
    link: '/culture',
  },
  {
    title: {
    ...
    image: "https://tamizhiv2.s3.eu-north-1.amazonaws.com/tamizhi2-0/architureimg.webp",
    link: '/architecture',
  },
  {
    title: {
    ...
    description: {
      ...
      ta: 'பல நூற்றாண்டுகளைக் கடந்த பண்டைய நகரங்கள் மற்றும் புனிதத் தலங்கள் வழியாக ஒரு பயணத்தைத் தொடங்குங்கள்.மதுரையிலிருந்து காஞ்சிபுரம் வரை, ஒவ்வொரு இடமும் தமிழ் மகத்துவத்தின் நிரூபணங்களை மெல்லிசையாகக் கூறுகிறது.ஒரு புகழ்பெற்ற கடந்த காலத்தை பிரதிபலிக்கும் மறைந்திருக்கும் ரத்தினங்களையும், சின்னச் சின்ன அடையாளங்களையும் தமிழியுடன் சேர்ந்து கண்டறியுங்கள்....',
    },
    image: "https://tamizhiv2.s3.eu-north-1.amazonaws.com/tamizhi2-0/historicalimg.webp",
    link: '/historical_place',
  },
  {
    title: {
      en: 'Excavation',
      ta: 'பழமையான அகழ்வுகள்',
    },
      ...
      <div className={styles.wrapper} xs={12} sm={12} md={3}>
        ...
        <div className={styles.more}>
          <button className={styles.more1} onClick={handleMoreClick}>
            {language === 'en' ? 'More Categories' : 'மேலும் பிரிவுகள்'}
          </button>
        </div>
      </div>
    </div>
